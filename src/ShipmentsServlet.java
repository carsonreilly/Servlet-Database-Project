...
@WebServlet("/shipmentsForm")
public class ShipmentsServlet extends HttpServlet {
	private int mysqlUpdateValue;
	private Connection connection;
	private Statement statement;
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
    	String command1=request.getParameter("s1");
    	String command2=request.getParameter("s2");
    	String command3=request.getParameter("s3");
    	String command4=request.getParameter("s4");
    	String message="";
    	Properties properties=new Properties();
        MysqlDataSource dataSource=null;
    	int c=Integer.parseInt(command4);
    	String sqlStatement="insert into shipments values(\""+command1+"\", \""+command2+"\", \""+command3+"\", "+command4+")";
    	try {
