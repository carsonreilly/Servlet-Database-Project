...
public class JobsServlet extends HttpServlet{
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
    	String command1=request.getParameter("j1");
    	String command2=request.getParameter("j2");
    	String command3=request.getParameter("j3");
    	String command4=request.getParameter("j4");
    	String message="";
    	Properties properties=new Properties();
        MysqlDataSource dataSource=null;
    	int c=Integer.parseInt(command3);
    	String sqlStatement="insert into jobs values(\""+command1+"\", \""+command2+"\", "+command3+", \""+command4+"\")";
    	try {
