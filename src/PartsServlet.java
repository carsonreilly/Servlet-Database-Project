...
@WebServlet("/partsForm")
public class PartsServlet extends HttpServlet{
	private int mysqlUpdateValue;
	private Connection connection;
	private Statement statement;
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
    	String command1=request.getParameter("p1");
    	String command2=request.getParameter("p2");
    	String command3=request.getParameter("p3");
    	String command4=request.getParameter("p4");
    	String command5=request.getParameter("p5");
    	String message="";
    	Properties properties=new Properties();
        MysqlDataSource dataSource=null;
    	int c=Integer.parseInt(command4);
    	String sqlStatement="insert into parts values(\""+command1+"\", \""+command2+"\", \""+command3+"\", "+command4+", \""+command5+"\")";
    	try {
